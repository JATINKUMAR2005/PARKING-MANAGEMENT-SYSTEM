    ...
    <div class="header">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="images/png-transparent-bmw-x1-car-bmw-x3-bmw-3-series-bmw-compact-car-driving-car-removebg.png" class="car" style="width: 650px; height: 250px; margin-top: 200px;" alt="car picture">
                </div>
            </div>
        </div> 
